...
## For other environments e.g. python, julia, etc

Info on configuration files can be found on
...
## Adjust default.html in _includes/themes>twitter
...
- Download webpage in your gh-pages branch
